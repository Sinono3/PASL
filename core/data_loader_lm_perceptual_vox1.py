    ...
    def __getitem__(self, index):
        if self.multi:
            ...
            if self.train_data == "mpie":
                ...
                lm = (
                    fname2.split("crop_256")[0]
                    + "depths_256"
                    + fname2.split("crop_256")[1]
                )
                pncc = (
                    fname2.split("crop_256")[0]
                    + "depths_256"
            ...
            lm = Image.open(lm).convert("RGB")
            img_lm2 = get_depth_render(self.deca, self.face_detector, fname, fname2)
