...
from models.bfm.bfm import BFMModel
from models.bfm.bfm_onnx import convert_bfm_to_onnx
...
class TDDFA_ONNX(object):
    ...
    def __init__(self, **kvs):
        ...
        bfm = BFMModel(
            bfm_fp, shape_dim=kvs.get("shape_dim", 40), exp_dim=kvs.get("exp_dim", 10)
        )
        self.tri = bfm.tri
